function koreBotChat(_cnf) {
            ...
            if (tempData.from === "bot" && tempData.type === "bot_response") {
                if (tempData.message[0]) {
                    ...
                    if (tempData.message[0].component && tempData.message[0].component.payload && tempData.message[0].component.payload.text) {
                        ...
                        if (_cnf.koreLogger) {
                           console.log("BOT RES:" + tempData.message[0].component.payload.text);
                           _cnf.koreLogger.recordMsg(tempData, 'botMessage');
                        }
                    }
                }
    ...
    chatWindow.prototype.sendMessage = function (chatInput,renderMsg) {
        ...
        attachmentInfo = {};
         ...
         if (_cnf.koreLogger) {
            console.log("USER MSG" + chatInput.text());
            _cnf.koreLogger.recordMsg(messageToBot, 'userMessage');
        }
